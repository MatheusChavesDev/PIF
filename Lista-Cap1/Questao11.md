...
\r	                     Sequência de escape	| char (ou int)
...
\xDC	Sequência de escape (hexadecimal)	char (ou int)
'\"'	Constante de caractere (com sequência de escape)	char (ou int)
'\\'	Constante de caractere (com sequência de escape)	char (ou int)
'F'	Constante de caractere	char (ou int)
0	Constante inteira decimal / octal	int
'\0'	Constante de caractere (caractere nulo)	char (ou int)
"F"	Constante string (literal de texto)	char[] (ou char *)
